...
then
  ...
  hdiutil attach -quiet chrome.dmg
...
then
  ...
  hdiutil attach -quiet discord.dmg
...
then
  ...
  hdiutil attach -quiet obsidian.dmg
...
then
  ...
  hdiutil attach -quiet notion.dmg
...
then
  ...
  hdiutil attach -quiet gdrive.dmg
